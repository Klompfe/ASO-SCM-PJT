# GEMINI CLI - 프로젝트 전역 규칙 및 지침 (Project Instructions)

본 문서는 NestJS, TypeORM, TypeScript 기반의 SCM(Supply Chain Management, 공급망 관리) 백엔드 프로젝트 개발 시 준수해야 하는 전역 규칙 및 가이드라인입니다. 모든 개발자 및 AI 어시스턴트는 코드를 수정하거나 새로운 기능을 추가할 때 본 문서의 지침을 반드시 준수해야 합니다.
...
### 3.2 트랜잭션 관리와 에러 롤백 (QueryRunner)
...
## 4. 코드 보존 및 스타일 규칙 (Code Preservation & Style)
